...
import com.procurement.clarification.infrastructure.configuration.properties.CassandraProperties
...
@ComponentScan(
    basePackages = [
        "com.procurement.clarification.infrastructure.repository"
    ]
)
